...
function timeForaction(mine, speed, slowdown) {
    slowdown = 0.5

    t = mine / (speed - slowdown)
    alert("У вас " + t + " минут ");
}
let mine = prompt('Какая Высота шахты?')
let speed = prompt('Скорость обычного таракана обычно', '1')

timeForaction(mine, speed)